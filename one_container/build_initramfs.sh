...
# 移除可能导致问题的空目录
rm -rf proc sys dev tmp run var/empty 2>/dev/null || true
...
echo "  iptables, ip6tables, ipset, ip, tc"
...
for tool in iptables ip6tables ipset ip modprobe sh; do
    FOUND=0
